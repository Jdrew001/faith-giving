export class GiveConstants {
    ...
    public static PAYMENT_METHODS = 'api/individual/paymentMethods';
    ...
    public static STRIPE_PK_TEST = 'pk_test_51IWOf3A0DJoBf0VzbZR7l3xohneGilLnLoYtjesw2BED5SqjGsV8TZa2Xx9d68RCFlmAN87ErPgQhx9UMT1yrC1400omCjotV3';
    public static RATE_FEE = 0.022;
}